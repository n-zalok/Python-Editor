...
function LandingEditor({ initialCode, onChange, charLimit = 1800 }) {
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-4 shadow-xl shadow-slate-950/20">
        <div className="flex items-center justify-between pb-3">
          <div>
            ...
            <p className="text-sm text-slate-400">Paste or type Python code to get ML-driven recommendations.</p>
          </div>
